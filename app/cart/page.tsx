                                ...
                                {cart.map((item, index) => (
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            checked={checkedItems[`${item.productId}-${index}`] ?? false}
                                            onCheckedChange={(checked) =>
                                                toggleItemCheck(item.productId, index, checked as boolean)
                                            }
                                        />
                                        <Link
                ...
                <div className="lg:block hidden lg:col-span-1 col-span-4 space-y-4">
                    <div className="bg-white rounded-xl p-6 space-y-4">
                        ...
                        <p className="flex items-center justify-between">
                            ...
                            <span className="font-medium text-xl">₦{subTotal.toLocaleString()}</span>
                        </p>

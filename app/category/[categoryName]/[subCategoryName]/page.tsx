...
const SubCategoryProductsPage = dynamic(() => import("@/components/category/SubCategoriesProductsPage"), {
    ssr: false,
    loading: () => (
...
export default async function Page({
    ...
    const { allCategories, fetchingAllCategories } = useGetAvailableSecondSubCategories(
        decodeURIComponent(categoryName),
        decodeURIComponent(subCategoryName)
    );

...
const SecondSubCategoryPage = ({
    ...
    const breadcrumbItems = [
        { label: "Home", href: "/" },
        {
            label: isMobile ? "..." : capitalizeFirstLetterOfEachWord(decodeURIComponent(Category)),
            href: `/category/${Category}`,
        },
        {
            label: isMobile ? "..." : capitalizeFirstLetterOfEachWord(decodeURIComponent(SubCategory)),
            href: `/category/${Category}/${SubCategory}`,
        },
        {
            label: capitalizeFirstLetterOfEachWord(decodeURIComponent(SecondSubCategory)),
        },
    ];
    ...
    if (status === "error") {
        return <ErrorComponent message="Failed to load group buy products." action={refetchFilterProducts} />;
    }
            ...
            <div className="h-[72px] bg-white rounded-lg lg:p-4 mx-1 lg:mx-8 flex items-center justify-between">
                ...
                <div className="lg:flex items-center space-x-4 hidden">
                    ...
                    <>
                        ...
                        >
                            <p className="font-medium">{getSortLabel(sort) || "Default Sorting"}</p>
                            <ChevronDownIcon
                                className={cn(

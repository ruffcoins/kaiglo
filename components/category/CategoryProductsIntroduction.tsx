...
const CategoryProductsIntroduction = ({
    ...
    const { filterProducts, refetchFilterProducts, isRefetching, error, isFetching } = useFilterProducts(
        filters,
        6
    );
    ...
    if (error) {
        return (
            <ErrorComponent message="Failed to load top selling products." action={refetchFilterProducts} />
        );
    }
